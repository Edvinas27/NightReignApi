...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference("Weapon.count") do
      post weapons_url, params: { weapon: { level_requirement: @weapon.level_requirement, name: @weapon.name, quality: @weapon.quality, type: @weapon.type } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { level_requirement: @weapon.level_requirement, name: @weapon.name, quality: @weapon.quality, type: @weapon.type } }
